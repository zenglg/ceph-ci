...
OPTION(bluestore_latency_managed_throttle, OPT_BOOL, false)
OPTION(bluestore_throttle_latency_min, OPT_U32, 300)
OPTION(bluestore_throttle_latency_max, OPT_U32, 500)
OPTION(bluestore_throttle_latency_window_msec, OPT_U32, 2000)
