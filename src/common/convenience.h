...
//
#define UNIQUE_LOCK_T(m) ::std::unique_lock<decltype(m)>
#define SHARED_LOCK_T(m) ::std::shared_lock<decltype(m)>
#define SHUNIQUE_LOCK_T(m) ::ceph::shunique_lock<decltype(m)>
