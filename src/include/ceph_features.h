...
#define CEPH_FEATURE_INCARNATION_3 (1ull<<21) // CEPH_FEATURE_SERVER_LUMINOUS
...
DEFINE_CEPH_FEATURE(16, 3, SERVER_M)
...
DEFINE_CEPH_FEATURE(28, 2, FORCE_BACKFILL)
