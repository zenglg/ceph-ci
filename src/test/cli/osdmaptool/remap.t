  ...
  $ cat c
  ceph osd pg-remap-items 0.3 54 52 212 213 156 155
  ceph osd pg-remap-items 0.1b 158 155 231 227 143 142
  ceph osd pg-remap-items 0.22 168 163 54 52 136 135
  ceph osd pg-remap-items 0.2e 87 86 160 155 54 52
  ceph osd pg-remap-items 0.6f 69 65 54 52 157 155
  ceph osd pg-remap-items 0.12b 54 52 90 86 226 227
  ceph osd pg-remap-items 0.13f 54 52 96 95 43 46
  ceph osd pg-remap-items 0.151 36 42 54 52 5 1
  ceph osd pg-remap-items 0.185 60 61 54 52 73 75
  ceph osd pg-remap-items 0.1e3 54 52 46 45 199 198
  ceph osd pg-remap-items 0.272 149 151 54 52 185 184
  $ rm -f om c
